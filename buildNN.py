        ...
        for index,(name,NN) in enumerate(zip(names,NNs)):
            ...
            if height==1:
                ...
                NN.plotPredictions(axes=axes,lr=lr,epochs=epochs,
                                   typeOfProblem=typeOfProblem,offset=offset,subplots=True,ax=axs[index],fig=fig)
                ...
                NN.plotPredictions(axes=axes, lr=lr, epochs=epochs,
                                   ...
                                   ax=axs[index // length,index % height], fig=fig, name=name)
...
F.plotPredictions(typeOfProblem="classification3")
